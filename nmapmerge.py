...
#
def main_nMapMerger(xmlSet,output):
	HOSTS = 0
...
if __name__ == "__main__":
	...
	parser.add_argument("-o", "--output", 	dest="output", help="output FILE", metavar="OUTPUT")
	...
	if args.filename is not None:
		f = args.filename
		if f.endswith('.xml') and not f.startswith('dpux_clean') :
